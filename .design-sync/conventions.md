...
| Facts | `<dl class="sds-facts">` — a block of terms and their values, scanned down the terms: no indent, and a shorter step from a name to what it is than to the next name. A bare `<dl>` is the prose form and is read rather than scanned |
