...
TASKS := verify test cards embed chrome typecheck fit rhythm audit ssr coverage php css build dist split guides fonts icons \
         diagrams baseline shots diff sheets look sync status plan synced
