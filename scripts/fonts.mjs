...
for (const { pkg, family, faces } of FAMILIES) {
  ...
  font-weight: ${weight};
  font-display: swap;
  src: url('${fileName}') format('woff2');${range ? `\n  unicode-range: ${range[1].trim()};` : ''}
}`);
    }
  }
...
writeFileSync(join(OUT, 'fonts.css'), `/* GENERATED by scripts/fonts.mjs — do not edit.
...
${versions}
   ...
   \`npm run fonts\` after changing the face list in the script. */
