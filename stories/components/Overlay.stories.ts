/* The wash a floating surface sits on.
   ...
   `Surface.stories.ts` generates. The claim on the page is about the pair —
   a plane and the thing over it — and neither half makes it alone.
...
/** `--surface-overlay` over whatever it gets, and nothing else. What
