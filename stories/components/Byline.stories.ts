/* Who wrote it, and when.
   ...
   is one line, and what deserves a document is the order — who, what they
   are to the subject, when — which a picture cannot show. A page that puts
   the date first has published a date.

   The mark is initials and never a photograph. A face is a file to fetch,
   keep in step and licence, and none of that is what a byline is for. */
...
/** Where the name leads somewhere — a profile, or the source behind the
    attribution. The link is on the name and nothing else: a date is not a
    destination. */
