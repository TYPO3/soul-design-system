...
<Specimen src="guidelines/states-focus.card.html" viewport="700x230" title="Focus & keyboard" />

## Loading

Nothing under 200ms. Over 2s the label says *why*: "booting the
installation", "reading packages instead", "searching docs.typo3.org".
Skeletons only where the shape is already known.

<Specimen src="guidelines/states-loading.card.html" viewport="700x275" title="Loading" />
...
<Specimen src="guidelines/states-empty.card.html" viewport="700x260" title="Empty & not found" />
...
<Specimen src="guidelines/states-error.card.html" viewport="700x420" title="Errors & degraded answers" />
