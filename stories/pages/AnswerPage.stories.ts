...
export function answerPage({ flat = false }: PageMode = {}): TemplateResult {
  ...
  <main class="sds-page" id="main-content">
    <!-- An answer is one section — a title, what it is bound to, the answer, what it
         leaves out — so the flow contract is the whole of its rhythm and there is
         nothing here for a stack to hold together. -->
    <div id="answer">
