...
export function toolReferencePage({ flat = false }: PageMode = {}): TemplateResult {
  ...
  <main class="sds-page" id="main-content">
    <!-- One section: the list is the page, and everything else on it says what the
         list is. No stack, because the flow contract already states every step
         between these blocks and a stack would restate them all as one. -->
    <div id="tools">
