...
<path d="M88.00 5.5H108A14.5 14.5 0 0 1 122.5 20V58.00Z" fill="var(--accent)" stroke="var(--accent)" stroke-width="11" stroke-linejoin="round" stroke-linecap="round" />
  ...
  <div>
    ...
    <div style="display:flex; align-items:flex-end; gap:26px; flex-wrap:wrap;">
      <div style="display:flex; flex-direction:column; align-items:center; gap:7px;"><img src="../assets/dev-companion-signet-l.svg" alt="" style="height:64px; width:81.92px; display:block;" /><span style="font-family:var(--font-mono); font-size:10px; color:var(--text-muted);">signet-l</span></div>
      <div style="display:flex; flex-direction:column; align-items:center; gap:7px;"><img src="../assets/dev-companion-signet-l.svg" alt="" style="height:32px; width:40.96px; display:block;" /><span style="font-family:var(--font-mono); font-size:10px; color:var(--text-muted);">signet-l &#183; 32</span></div>
      <div style="display:flex; flex-direction:column; align-items:center; gap:7px;"><img src="../assets/dev-companion-signet-m.svg" alt="" style="height:24px; width:30.72px; display:block;" /><span style="font-family:var(--font-mono); font-size:10px; color:var(--text-muted);">signet-m &#183; 24</span></div>
      <div style="display:flex; flex-direction:column; align-items:center; gap:7px;"><img src="../assets/dev-companion-signet-s.svg" alt="" style="height:16.384px; width:20.48px; display:block;" /><span style="font-family:var(--font-mono); font-size:10px; color:var(--text-muted);">signet-s &#183; 16</span></div>
