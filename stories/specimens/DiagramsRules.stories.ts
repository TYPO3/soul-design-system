...
const RULES: readonly string[] = [
  ...
  '<b>Two files, one drawing.</b> Colour is written as attributes, and the dark file is generated from the light one by a token swap. A <span class="spec-cap">&lt;style&gt;</span> block inside an SVG is stripped by GitHub, so a self-switching file is not shippable — the pair is selected with <span class="spec-cap">&lt;picture&gt;</span>.',
...
const meta: Meta = {
  ...
  parameters: {
    dsCard: dsCard({
      ...
      group: 'Diagrams',
      name: 'Drawing rules',
      subtitle: 'Flat, hairline, one accent — shipped as a light/dark pair',
      viewport: '980x510',
    }),
  },
};
