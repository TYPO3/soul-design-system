...
const CARD = `<div class="spec-pad" style="display:grid; grid-template-columns:repeat(2, 1fr); gap:22px 18px;">
  <div style="display:flex; flex-direction:column; gap:9px; align-items:flex-start; overflow:hidden;">
    <div style="height:30px; display:flex; align-items:center;"><span style="display:inline-flex; align-items:center; gap:7.5px;"><svg viewBox="0 0 128 100" width="26.11" height="20.40" class="sds-signet sds-signet--muted">
...
<path d="M72 4.25H108A15.75 15.75 0 0 1 123.75 20V56" fill="none" stroke="var(--accent)" stroke-width="8.5" stroke-linejoin="round" stroke-linecap="round" />
  ...
  <div style="display:flex; flex-direction:column; gap:9px; align-items:flex-start; overflow:hidden;">
    <div style="height:30px; display:flex; align-items:center;"><span style="display:inline-block; transform:scaleX(1.35); transform-origin:left;"><span style="display:inline-flex; align-items:center; gap:7.5px;"><svg viewBox="0 0 128 100" width="26.11" height="20.40" class="sds-signet sds-signet--muted">
<path d="M56 95.75H20A15.75 15.75 0 0 1 4.25 80V44" fill="none" stroke="var(--text-secondary)" stroke-width="8.5" stroke-linejoin="round" stroke-linecap="round" />
<rect x="39" y="30.5" width="10.5" height="39" rx="4.25" fill="var(--text-muted)" /><rect x="53.75" y="30.5" width="20.5" height="39" rx="4.25" fill="var(--text-muted)" /><rect x="78.5" y="30.5" width="10.5" height="39" rx="4.25" fill="var(--text-muted)" />
<path d="M72 4.25H108A15.75 15.75 0 0 1 123.75 20V56" fill="none" stroke="var(--accent)" stroke-width="8.5" stroke-linejoin="round" stroke-linecap="round" />
  ...
  <div style="display:flex; flex-direction:column; gap:9px; align-items:flex-start; overflow:hidden;">
    <div style="height:30px; display:flex; align-items:center;"><span style="display:inline-flex; align-items:center; justify-content:center; width:30px; height:30px; background:var(--accent); border-radius:7px;"><svg viewBox="0 0 128 100" width="23.04" height="18.00" class="sds-signet" style="color:var(--text-on-accent);">
...
<path d="M72 5.5H108A14.5 14.5 0 0 1 122.5 20V56" fill="none" stroke="var(--text-on-accent)" stroke-width="11" stroke-linejoin="round" stroke-linecap="round" />
  ...
  <div style="display:flex; flex-direction:column; gap:9px; align-items:flex-start; overflow:hidden;">
    <div style="height:30px; display:flex; align-items:center;"><svg viewBox="0 0 128 100" width="28.16" height="22.00" class="sds-signet sds-signet--muted">
