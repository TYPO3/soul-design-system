...
<path d="M14 4H21A2 2 0 0 1 23 6V13" fill="none" stroke="var(--accent)" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" />
  ...
  <div style="display:flex; flex-direction:column; gap:9px; align-items:flex-start; overflow:hidden;">
    <div style="height:30px; display:flex; align-items:center;"><span style="display:inline-flex; align-items:center; justify-content:center; width:30px; height:30px; background:var(--accent); border-radius:7px;"><svg viewBox="0 0 24 24" width="24" height="24" class="sds-signet" style="color:var(--text-on-accent);">
<path d="M10 20H3A2 2 0 0 1 1 18V11" fill="none" stroke="var(--text-on-accent)" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" />
<rect x="6" y="8" width="2" height="8" rx="1" fill="var(--text-on-accent)" /><rect x="10" y="8" width="4" height="8" rx="1" fill="var(--text-on-accent)" /><rect x="16" y="8" width="2" height="8" rx="1" fill="var(--text-on-accent)" />
<path d="M14 4H21A2 2 0 0 1 23 6V13" fill="none" stroke="var(--text-on-accent)" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" />
</svg></span></div>
