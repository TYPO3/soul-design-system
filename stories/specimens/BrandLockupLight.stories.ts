...
<path d="M72 3.5H108A16.5 16.5 0 0 1 124.5 20V56" fill="none" stroke="var(--accent)" stroke-width="7" stroke-linejoin="round" stroke-linecap="round" />
  ...
  <div style="display:flex; align-items:center; gap:38px; flex-wrap:wrap; padding-top:18px; border-top:1px solid var(--border-subtle);"><span style="display:inline-flex; align-items:center; gap:8.5px;"><svg viewBox="-6 -6 140 112" width="32.37" height="25.89" class="sds-signet sds-signet--muted">
