...
const CARD = `<div style="padding:22px; display:flex; align-items:flex-end; gap:44px; flex-wrap:wrap;">
  <span style="display:inline-flex; flex-direction:column; align-items:flex-start; gap:11px;"><svg viewBox="0 0 32 32" width="32" height="32" class="sds-signet sds-signet--muted">
...
<path d="M14 4H21A2 2 0 0 1 23 6V13" fill="none" stroke="var(--accent)" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" />
    ...
    <span style="display:inline-flex; align-items:center; justify-content:center; width:28px; height:28px; background:var(--surface-inset); border-radius:6px;"><svg viewBox="0 0 16 16" width="16" height="16" class="sds-signet sds-signet--muted">
