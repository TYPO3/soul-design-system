...
const CARD = `<div style="padding:22px; display:flex; align-items:flex-end; gap:44px; flex-wrap:wrap;">
  <span style="display:inline-flex; flex-direction:column; align-items:flex-start; gap:11px;"><svg viewBox="0 0 128 100" width="48.64" height="38.00" class="sds-signet sds-signet--muted">
...
<path d="M72 3.5H108A16.5 16.5 0 0 1 124.5 20V56" fill="none" stroke="var(--accent)" stroke-width="7" stroke-linejoin="round" stroke-linecap="round" />
  ...
  <div style="display:flex; align-items:flex-end; gap:14px;">
    <span style="display:inline-flex; align-items:center; justify-content:center; width:56px; height:56px; background:var(--surface-inset); border-radius:12px;"><svg viewBox="0 0 128 100" width="38.40" height="30.00" class="sds-signet sds-signet--muted">
...
<path d="M72 4.25H108A15.75 15.75 0 0 1 123.75 20V56" fill="none" stroke="var(--accent)" stroke-width="8.5" stroke-linejoin="round" stroke-linecap="round" />
    ...
    <span style="display:inline-flex; align-items:center; justify-content:center; width:40px; height:40px; background:var(--surface-inset); border-radius:9px;"><svg viewBox="0 0 128 100" width="28.16" height="22.00" class="sds-signet sds-signet--muted">
<path d="M56 95.75H20A15.75 15.75 0 0 1 4.25 80V44" fill="none" stroke="var(--text-secondary)" stroke-width="8.5" stroke-linejoin="round" stroke-linecap="round" />
<rect x="39" y="30.5" width="10.5" height="39" rx="4.25" fill="var(--text-muted)" /><rect x="53.75" y="30.5" width="20.5" height="39" rx="4.25" fill="var(--text-muted)" /><rect x="78.5" y="30.5" width="10.5" height="39" rx="4.25" fill="var(--text-muted)" />
<path d="M72 4.25H108A15.75 15.75 0 0 1 123.75 20V56" fill="none" stroke="var(--accent)" stroke-width="8.5" stroke-linejoin="round" stroke-linecap="round" />
</svg></span>
    <span style="display:inline-flex; align-items:center; justify-content:center; width:28px; height:28px; background:var(--surface-inset); border-radius:6px;"><svg viewBox="0 0 128 100" width="20.48" height="16.00" class="sds-signet sds-signet--muted">
